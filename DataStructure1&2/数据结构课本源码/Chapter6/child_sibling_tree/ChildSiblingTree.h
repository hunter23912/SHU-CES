...
protected:
	...
	ChildSiblingTreeNode<ElemType> *Parent(ChildSiblingTreeNode<ElemType> *r, const ChildSiblingTreeNode<ElemType> *cur) const;
	//  求cur的双亲
...
template <class ElemType>
void DisplayTWithConcaveShape( ChildSiblingTree<ElemType> &t,
